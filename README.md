...
- **Visualización 3D**: representación interactiva de complejos proteína–ligando mediante NGL Viewer.
...
- Representación selectiva de cadenas laterales en el sitio de unión.
...
```bash
git clone https://github.com/elkyngranados/dayhoffdock.git
cd dayhoffdock
```
...
Si encuentras algún bug o tienes sugerencias, por favor abre un [issue](https://github.com/elkyngranados/dayhoffdock/issues) en GitHub.
...
- **Johan Granados** — [@elkyngranados](https://github.com/elkyngranados)
- **Andrés Pereañez**
- **Lina Preciado**
...
@software{dayhoffdock2026,
  ...
  year={2026},
  url={https://github.com/elkyngranados/dayhoffdock}
}
```

## Agradecimientos

- AutoDock Vina team, por el software de docking.
...
- Selective representation of side chains in the binding site.
...
If you find any bugs or have suggestions, please open an [issue](https://github.com/elkyngranados/dayhoffdock/issues) on GitHub.
...
For questions or collaborations, please use GitHub Issues or email.

---

<div align="center">

© 2026 DayhoffDock | [GitHub](https://github.com/elkyngranados/dayhoffdock)
